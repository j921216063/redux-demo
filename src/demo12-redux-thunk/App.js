    ...
    return (
      <div className="container">
        ...
        <p className="text-center">
          ...
          <button onClick={this.handleAyncIncrement} className="btn btn-primary mr-2">Aync Increase</button>
...
export default connect(mapStateToProps, { increment, decrement, asyncIncrement })(App);
